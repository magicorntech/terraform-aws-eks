# Create Kubernetes Role for Cluster Autoscaler
resource "aws_iam_role" "cluster_autoscaler" {
  name = "${var.tenant}-${var.name}-eks-autoscaler-role-${random_id.iam.hex}-${var.environment}"
...
# Create Kubernetes Role Policy for Cluster Autoscaler
resource "aws_iam_role_policy" "cluster_autoscaler_policy" {
  name = "${var.tenant}-${var.name}-eks-autoscaler-policy-${random_id.iam.hex}-${var.environment}"
...
# Create Kubernetes Role Policy for AWS Load Balancer Controller
resource "aws_iam_role_policy" "alb_controller_policy" {
  name = "${var.tenant}-${var.name}-eks-load-balancer-policy-${random_id.iam.hex}-${var.environment}"
